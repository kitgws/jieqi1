...
case "post":
	...
	if (empty($errtext)) {
		...
		$postrows["sumegold"] = ceil($obook->getVar("sumegold", "n") * $fc / 100);
		$postrows["sumesilver"] = $obook->getVar("sumesilver", "n");
		$postrows["sumemoney"] = ceil($obook->getVar("sumemoney", "n")* $fc / 100);
