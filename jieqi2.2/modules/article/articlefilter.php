...
$ajax_order=$_REQUEST['order'];
$ajax_sortid=$_REQUEST['sortid'];
$ajax_isfull=$_REQUEST['isfull'];
$ajax_size=$_REQUEST['size'];
$jieqiTpl->assign( "ajax_sortid", $ajax_sortid );
$jieqiTpl->assign( "ajax_isfull", $ajax_isfull );
$jieqiTpl->assign( "ajax_order", $ajax_order );
$jieqiTpl->assign( "ajax_size", $ajax_size );
