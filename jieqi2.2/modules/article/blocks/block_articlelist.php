...
class BlockArticleArticlelist extends JieqiBlock
{
	...
	public $exevars = array("order" => "allvisit", "listnum" => 10, "sortid" => 0, "original" => 0, "isfull" => 0, "asc" => 0, "isvip" => 0, "rgroup" => -1);
	...
	public function setContent($isreturn = false)
	{
		...
		if (($this->exevars["isvip"] == 1) || ($this->exevars["isvip"] == 3)) {
			...
			if ($jieqiTop["article"][$this->exevars["order"]]["sort"] != "") {
				...
				$sortfield = str_replace($orderfrom, $orderto, $jieqiTop["article"][$this->exevars["order"]]["sort"]);
			}
